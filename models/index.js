...
// so the env variable in this production will be 'production'

// if the app is running in your computer, then env wil be 'development
// app will use SQLite
...
db.sequelize = sequelize // information on how to connect to the dababase
